...
import IncentiveForm from "@/components/governance/IncentiveForm";
...
export default async function NewIncentivePage() {
  ...
  return (
    <div>
      ...
      <h1 className="mb-6 text-xl font-semibold text-text-1">{t("newIncentive")}</h1>
      <IncentiveForm employees={employees} />
    </div>
  );
}
